            ...
            <div className="container mx-auto">
                <div className="w-90% mx-auto py-20">
                    ...
                    <div className="flex mx-auto text-[#aaa] justify-center gap-3 items-center mt-8 flex-wrap">
                        <Link href='tel: 0942870419' className="flex items-center tracking-wide hover:text-background-btn transition-all duration-150 gap-1.5">
                            <PhoneIcon classProp="w-6 h-6" />
                            <span>+84 942 870 419</span>
                        </Link>
                        <Link href='mailto: nhuttantranle@gmail.com' className="flex items-center tracking-wide hover:text-background-btn transition-all duration-150 gap-1.5">
                            <EnvelopIcon classProp="w-6 h-6" />
                            <span>nhuttantranle@gmail.com</span>
                        </Link>
                        <p className="flex items-center tracking-wide hover:text-background-btn transition-all duration-150 gap-1.5">
